  ...
  \subsection{Some dp patterns}
   ...
   \subsection{DP solutions}
     ...
     \subsubsection{Longest common subsequence between 2 Strings}
       ...
       \subsubsection{Longest common subsequence $\mathcal{O}(n^2)$}
          \includeCode{c++}{LIS}{lhstyle}{solutions/lis.cpp}


      \subsubsection{Longest common subsequence Binary Search $\mathcal{O}(n + \log N)$}
          \includeCode{c++}{LIS}{lhstyle}{solutions/lisBinarySearch.cpp}